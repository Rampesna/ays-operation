...
//        Route::post('');
        ...
        Route::prefix('task')->group(function () {
            Route::post('create', 'TaskController@create')->name('ajax.project.task.create');
            ...
            Route::post('order-update', 'TaskController@orderUpdate')->name('ajax.project.task.order-update');
