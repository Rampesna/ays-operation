    ...
    1: [function (e, t, n) {
        ...
        !function () {
            this.jKanban = function () {
                ...
                function T(e) {
                    var t = e;
                    if (b.options.itemHandleOptions.enabled) if (void 0 === (b.options.itemHandleOptions.customHandler || void 0)) {
                        var n = b.options.itemHandleOptions.customCssHandler,
                            i = b.options.itemHandleOptions.customCssIconHandler;
                        void 0 === (n || void 0) && (n = "drag_handler"), void 0 === (i || void 0) && (i = n + "_icon"), t = "<div class='item_handle " + n + "'><i class='item_handle " + i + "'></i></div><div>" + t + "</div>"
                ...
                arguments[0] && "object" == typeof arguments[0] && (this.options = function (e, t) {
                    ...
                    !function () {
                        ...
                        if ("" !== n && -1 < n.indexOf("not-draggable")) b.drake.cancel(!0); else {
                            e.classList.add("is-moving");
                            var i = o(t.parentNode.dataset.id);
                            void 0 !== i.dragTo && b.options.boards.map(function (e) {
                        ...
                        void 0 !== r.dragTo && -1 === r.dragTo.indexOf(t.parentNode.dataset.id) && t.parentNode.dataset.id !== n.parentNode.dataset.id && b.drake.cancel(!0), null !== e && (!1 === b.options.dropEl(e, t, n, i) && b.drake.cancel(!0), e.classList.remove("is-moving"), "function" == typeof e.dropfn && e.dropfn(e, t, n, i))
                    }))
                }, this.enableAllBoards = function () {
                    var e = document.querySelectorAll(".kanban-board");
                    if (0 < e.length && void 0 !== e) for (var t = 0; t < e.length; t++) e[t].classList.remove("disabled-board")
                }, this.addElement = function (e, t) {
                    var n = b.element.querySelector('[data-id="' + e + '"] .kanban-drag'),
                        i = document.createElement("div");
                    return i.classList.add("kanban-item"), void 0 !== t.id && "" !== t.id && i.setAttribute("data-eid", t.id), t.class && Array.isArray(t.class) && t.class.forEach(function (e) {
                        i.classList.add(e)
                    ...
                    var n = b.element.querySelector('[data-id="' + e + '"] .kanban-drag'), i = t.getAttribute("class");
                    return t.setAttribute("class", i + " not-draggable"), n.appendChild(t), b
                }, this.addBoards = function (e, t) {
                    if (b.options.responsivePercentage) if (b.container.style.width = "100%", b.options.gutter = "1%", window.innerWidth > b.options.responsive) var n = (100 - 2 * e.length) / e.length; else n = 100 - 2 * e.length; else n = b.options.widthBoard;
                    var i = b.options.addItemButton, r = b.options.buttonContent;
                    for (var o in e) {
                        var a = e[o];
                        ...
                        if ("" !== a.class && void 0 !== a.class) var s = a.class.split(","); else s = [];
                        if (d.classList.add("kanban-board-header"), s.map(function (e) {
                            d.classList.add(e)
                        }), d.innerHTML = '<div class="kanban-title-board">' + a.title + "</div>", i) {
                            var u = document.createElement("BUTTON"), l = document.createTextNode(r);
                            u.setAttribute("class", "kanban-title-button btn btn-default btn-xs"), u.appendChild(l), d.appendChild(u), w(u, a.id)
                        }
                        var f = document.createElement("main");
                        if (f.classList.add("kanban-drag"), "" !== a.bodyClass && void 0 !== a.bodyClass) var p = a.bodyClass.split(","); else p = [];
                        for (var v in p.map(function (e) {
                            f.classList.add(e)
                        }), b.boardContainer.push(f), a.item) {
                            var m = a.item[v], h = document.createElement("div");
                            h.classList.add("kanban-item"), m.id && (h.dataset.eid = m.id), m.class && Array.isArray(m.class) && m.class.forEach(function (e) {
                                h.classList.add(e)
                        ...
                        c.appendChild(d), c.appendChild(f), c.appendChild(g), b.container.appendChild(c)
                    }
                    return b
                    ...
                    for (var n = 0; n < b.options.boards.length; n++) if (b.options.boards[n].id === e) {
        ...
        t.exports = function (r, e) {
            ...
            return void 0 === r && (r = {}), r.on = function (e, t) {
                ...
                if (1 === n) delete a[e]; else if (0 === n) a = {}; else {
                    var i = a[e];
                    if (!i) return r;
        ...
        (function (r) {
            "use strict";
            var o = n("custom-event"), a = n("./eventmap"), c = r.document, e = function (e, t, n, i) {
            ...
            function s(e, t, n) {
                var i = function (e, t, n) {
                    var i, r;
                    for (i = 0; i < d.length; i++) if ((r = d[i]).element === e && r.type === t && r.fn === n) return i
                }(e, t, n);
                if (i) {
                    var r = d[i].wrapper;
        ...
        (function (r) {
            "use strict";
            var M = e("contra/emitter"), X = e("crossvent"), Y = e("./classes"), j = document, F = j.documentElement;

            function R(e, t, n, i) {
                r.navigator.pointerEnabled ? X[t](e, {
                    mouseup: "pointerup",
                    mousedown: "pointerdown",
                    mousemove: "pointermove"
                }[n], i) : r.navigator.msPointerEnabled ? X[t](e, {
                    mouseup: "MSPointerUp",
            ...
            function z(e, t, n) {
                var i, r = e || {}, o = r.className;
                return r.className += " gu-hide", i = j.elementFromPoint(t, n), r.className = o, i
            }
            ...
            function ee(e, t) {
                ...
                }(t), i = {pageX: "clientX", pageY: "clientY"};
            ...
            t.exports = function (e, t) {
                ...
                var C = M({
                    containers: T.containers, start: function (e) {
                        var t = k(e);
                        t && S(t)
                ...
                function l(e) {
                    if (o = e.clientX, a = e.clientY, !(1 !== U(e) || e.metaKey || e.ctrlKey)) {
                        var t = e.target, n = k(t);
                        n && (c = n, s(), "mousedown" === e.type && (Q(t) ? t.focus() : e.preventDefault()))
                    }
                }
                    ...
                    if (c) if (0 !== U(e)) {
                        if (void 0 === e.clientX || e.clientX !== o || void 0 === e.clientY || e.clientY !== a) {
                            if (T.ignoreInputTextSelection) {
                                var t = ee("clientX", e), n = ee("clientY", e);
                            ...
                            h = ee("pageX", e) - r.left, g = ee("pageY", e) - r.top, Y.add(w || m, "gu-transit"), function () {
                                if (p) return;
                                var e = m.getBoundingClientRect();
                                (p = m.cloneNode(!0)).style.width = $(e) + "px", p.style.height = G(e) + "px", Y.rm(p, "gu-transit"), Y.add(p, "gu-mirror"), T.mirrorContainer.appendChild(p), R(F, "add", "mousemove", P), Y.add(T.mirrorContainer, "gu-unselectable"), C.emit("cloned", p, m, "mirror")
                            }(), P(e)
                        }
                    } else O({})
                }
                ...
                function k(e) {
                    if (!(C.dragging && p || d(e))) {
                        ...
                        var n = J(e);
                        if (n) if (!T.invalid(e, t)) if (T.moves(e, n, t, Z(e))) return {item: e, source: n}
                    }
                }
                ...
                function O(e) {
                    if (L(), C.dragging) {
                        var t = w || m, n = ee("clientX", e), i = ee("clientY", e), r = H(z(p, n, i), n, i);
                        r && (w && T.copySortSource || !w || r !== v) ? B(t, r) : T.removeOnSpill ? I() : N()
                    }
                }
                ...
                function N(e) {
                    if (C.dragging) {
                        var t = 0 < arguments.length ? e : T.revertOnSpill, n = w || m, i = J(n), r = A(i);
                        !1 === r && t && (w ? i && i.removeChild(w) : v.insertBefore(n, b)), r || t ? C.emit("cancel", n, v, v) : C.emit("drop", n, i, v, y), _()
                    }
                }

                function _() {
                    var e = w || m;
                    L(), p && (Y.rm(T.mirrorContainer, "gu-unselectable"), R(F, "remove", "mousemove", P), J(p).removeChild(p), p = null), e && Y.rm(e, "gu-transit"), n && clearTimeout(n), C.dragging = !1, E && C.emit("out", e, E, v), C.emit("dragend", e), v = m = w = b = y = n = E = null
                }
                ...
                function P(e) {
                    if (p) {
                        e.preventDefault();
                        var t = ee("clientX", e), n = ee("clientY", e), i = t - h, r = n - g;
                        p.style.left = i + "px", p.style.top = r + "px";
                        var o = w || m, a = z(p, t, n), c = H(a, t, n), d = null !== c && c !== E;
                        !d && null !== c || (E && f("out"), E = c, d && f("over"));
                        var s = J(o);
                        if (c !== v || !w || T.copySortSource) {
                            var u, l = q(c, a);
                            if (null !== l) u = D(c, l, t, n); else {
                ...
                function D(r, t, o, a) {
                    ...
                    return t !== r ? function () {
                        ...
                        var e, t, n, i = r.children.length;
                        for (e = 0; e < i; e++) {
                            if (t = r.children[e], n = t.getBoundingClientRect(), c && n.left + n.width / 2 > o) return t;
        ...
        (function (e, t) {
            var i = d("process/browser.js").nextTick, n = Function.prototype.apply, r = Array.prototype.slice, o = {},
                a = 0;
            ...
            s.setTimeout = function () {
                ...
                var t = a++, n = !(arguments.length < 2) && r.call(arguments, 1);
