...
class SurveySystemApi extends OperationApi
{
    ...
    public function SetSurvey(Request $request, $callList = [])
    {
        ...
        $params = [
            ...
            'uyumCrmAramaPlani' => intval($request->dial_plan),
            'uyumCrmFirsatSaticiyaYonlendir' => intval($request->opportunity_redirect_to_seller),
            'uyumCrmAramaPlaniSaticiyaYonlendir' => intval($request->dial_plan_redirect_to_seller),
            'UyumCrmEkUrunFirsat' => intval($request->additional_product_opportunity),
            'UyumCrmEkUrunAramaPlani' => intval($request->additional_product_call_plan),
            'uyumCrmSaticiKoduTurKodu' => intval($request->seller_redirection_type),
