...
<script>
    ...
    var meetingIdCreate = $("#meeting_id_create");
    var meetingIdEdit = $("#meeting_id_edit");
    ...
    function edit() {
        ...
        $.ajax({
            ...
            success: function (agenda) {
                $("#meeting_id_edit").val(agenda.meeting_id).selectpicker('refresh');
    ...
    function getMeetings() {
        $.ajax({
            type: 'get',
            url: '{{ route('ajax.application.meeting.index') }}',
            data: {},
            success: function (meetings) {
                meetingIdCreate.empty();
                meetingIdEdit.empty();
                meetingIdCreate.append(`<optgroup label=""><option value="">Seçim Yok</option></optgroup>`);
                meetingIdEdit.append(`<optgroup label=""><option value="">Seçim Yok</option></optgroup>`);
                $.each(meetings, function (index) {
                    meetingIdCreate.append(`<option value="${meetings[index].id}">${meetings[index].name}</option>`);
                    meetingIdEdit.append(`<option value="${meetings[index].id}">${meetings[index].name}</option>`);
                });
                meetingIdCreate.selectpicker('refresh');
                meetingIdEdit.selectpicker('refresh');
            },
            error: function (error) {
                toastr.error('Sistemsel Bir Hata Oluştu!');
                console.log(error)
    ...
    CreateButton.click(function () {
        var meeting_id = $("#meeting_id_create").val();
    ...
    UpdateButton.click(function () {
        var id = $("#id_edit").val();
        var meeting_id = $("#meeting_id_edit").val();
