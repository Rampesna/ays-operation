...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-3">
            <a href="{{ route('applications.batch-actions.index') }}" class="card card-custom card-stretch gutter-b">
                <div class="card-body">
        ...
        <div class="col-xl-3">
            <a href="{{ route('applications.custom-report.index') }}" class="card card-custom card-stretch gutter-b">
                <div class="card-body">
                    ...
                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Özel Raporlar</div>
                </div>
            </a>
        </div>

        <div class="col-xl-3">
            <a href="{{ route('applications.meeting.index') }}" class="card card-custom card-stretch gutter-b">
                <div class="card-body">
                    ...
                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Toplantı Yönetimi</div>
                </div>
            </a>
        </div>
