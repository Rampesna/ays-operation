    ...
    <div class="modal-dialog" role="document" style="max-width:900px;">
        <div class="modal-content" style="margin-top: 50%">
            ...
            <div class="modal-body">
                <input type="hidden" name="updated_shift-group_id" id="updated_shift-group_id">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="form-group">
                            <label for="company_id_edit">Vardiya Grubunun Bağlı Olacağı Firmayı Seçin</label>
                    ...
                    <div class="col-xl-6">
                        <div class="form-group">
                            <label for="name_edit">Vardiya Grubunun Adı</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="shift-group_update">Güncelle</button>
