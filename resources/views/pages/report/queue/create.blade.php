...
@section('content')
    ...
    <form action="{{ route('report.queue-call-report') }}" method="post">
        @csrf
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    <label for="queues">Raporlanacak Kuyrukları Seçin</label>
                                    <select name="queues[]" id="queues" class="form-control selectpicker" data-live-search="true" multiple required>
