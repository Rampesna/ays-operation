        ...
        <div class="col-xl-3">
            <div class="card card-custom bg-primary card-stretch gutter-b" style="height: 200px">
                ...
                <div class="card-body cursor-pointer">
                    ...
                    <span class="card-title font-weight-bolder text-white mb-0 mt-6 d-block" style="font-size: 24px">0</span>
                    <span class="font-weight-bold text-white"  style="font-size: 20px">Toplam Konuşma Süresi</span>
                </div>
                <!--end::Body-->
            </div>
        </div>
        ...
        <div class="col-xl-6">
            <div class="card card-custom bg-primary card-stretch gutter-b" style="height: 200px">
                ...
                <div class="card-body cursor-pointer">
                    ...
                    <span class="card-title font-weight-bolder text-white mb-0 mt-6 d-block" style="font-size: 24px">0</span>
                    <span class="font-weight-bold text-white"  style="font-size: 20px">Toplam Faaliyet</span>
                </div>
                <!--end::Body-->
            </div>
        </div>
        <div class="col-xl-6">
            <div class="card card-custom bg-primary card-stretch gutter-b" style="height: 200px">
                ...
                <div class="card-body cursor-pointer">
                    ...
                    <span class="card-title font-weight-bolder text-white mb-0 mt-6 d-block" style="font-size: 24px">0</span>
                    <span class="font-weight-bold text-white"  style="font-size: 20px">Toplam Tamamlanan İş</span>
                </div>
                <!--end::Body-->
            </div>
        </div>
