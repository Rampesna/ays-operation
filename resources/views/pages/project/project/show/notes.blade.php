...
@section('content')
                            ...
                            <table class="table" id="notes">
                                ...
                                @foreach($project->notes as $note)
                                    <tr id="row_id_{{ $note->id }}">
                                        <td>
                                            @if($note->creator_type == 'App\Models\User' && $note->creator_id == auth()->user()->getId())
    ...
    @include('pages.project.project.show.modals.create-note')
    @include('pages.project.project.show.modals.edit-note')
    @include('pages.project.project.show.modals.delete-note')
