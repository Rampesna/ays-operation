            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-lg-5ths border-right pb-4 pt-4">
                        ...
                        <div class="col-lg-5ths border-right pb-4 pt-4">
                            <label class="mb-0 mr-5">Toplam Çalışma Süresi</label>
                            <span class="svg-icon svg-icon-3x svg-icon-warning">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect x="0" y="0" width="24" height="24"/>
                            ...
                            <h4 class="font-30 font-weight-bold text-col-blue mt-1" style="font-size: 20px">{{ $project->totalWorkingTime() }}</h4>
                        </div>
                        <div class="col-lg-5ths border-right pb-4 pt-4">
                        ...
                        <div class="col-lg-5ths pb-4 pt-4">
