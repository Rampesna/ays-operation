...
@section('title', $employee->name . ' - Ödemeler')
...
@section('content')
    ...
    @include('pages.ik.employee.show.payment.modals.create')
    @include('pages.ik.employee.show.payment.modals.edit')
    @include('pages.ik.employee.show.payment.modals.delete')
                    ...
                    <table class="table" id="payments">
                        ...
                        @foreach($payments as  $payment)
                            <tr>
                                ...
                                <td data-sort="{{ $payment->date }}">{{ strftime("%d %B %Y", strtotime($payment->date)) }}</td>
