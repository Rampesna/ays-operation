...
@section('title', $employee->name . ' - Fazla Mesailer')
...
@section('content')
    ...
    @include('pages.ik.employee.show.overtime.modals.create')
    @include('pages.ik.employee.show.overtime.modals.edit')
    @include('pages.ik.employee.show.overtime.modals.delete')
...
@section('page-styles')
    @include('pages.ik.employee.show.overtime.components.style')
@stop

@section('page-script')
    @include('pages.ik.employee.show.overtime.components.script')
@stop
