...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-6">
            <a href="{{ route('ik.application.recruiting.settings.evaluation-parameters.index') }}" class="card card-custom card-stretch gutter-b">
                <div class="card-body">
                    ...
                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Değerlendirme Parametreleri</div>
                </div>
            </a>
        </div>
