        ...
        <form action="{{ route('ik.application.payment.update') }}" method="post" class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="type_id_edit">Ödeme Türü</label>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="date_edit">Ödeme Tarihi</label>
                            <input type="date" id="date_edit" name="date" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="amount_edit">Ödenen Miktar</label>
                            <input type="text" id="amount_edit" name="amount" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label for="payroll_edit">Bordroya Dahil Edilsin</label>
                            <select class="form-control" id="payroll_edit" name="payroll" required>
