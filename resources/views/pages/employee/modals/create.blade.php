    ...
    <div class="modal-dialog" role="document" style="max-width:900px;">
        <div class="modal-content" style="margin-top: 25%">
            <div class="modal-header">
                <h5 class="modal-title">Personel Oluştur</h5>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="form-group">
                            <label for="company_id_create">Personelin Bağlı Olacağı Firmayı Seçin</label>
                    ...
                    <div class="col-xl-6">
                        <div class="form-group">
                            <label for="name_create">Personel Adı</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="competence_create">Oluştur</button>
