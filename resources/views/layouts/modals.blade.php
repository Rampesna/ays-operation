            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        @Authority(13)
                        <div class="col-xl-4">
                            <a href="{{ route('setting.company.index') }}" class="card card-custom card-stretch gutter-b">
                                <div class="card-body">
                        ...
                        @Authority(30)
                        <div class="col-xl-4">
                            <a href="{{ route('setting.shift-groups.index') }}" class="card card-custom card-stretch gutter-b">
                                <div class="card-body">
                                    <span class="svg-icon svg-icon-dark-75 svg-icon-3x ml-n1">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Vardiya Grupları</div>
                                </div>
                            </a>
                        </div>
                        @endAuthority
                        ...
                        <div class="col-xl-4">
                            <a href="{{ route('setting.device-groups.index') }}" class="card card-custom card-stretch gutter-b">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Cihaz Grubu Yönetimi</div>
                                </div>
                            </a>
                        </div>
                        @endAuthority
                        ...
                        <div class="col-xl-4">
                            <a href="{{ route('setting.device-statuses.index') }}" class="card card-custom card-stretch gutter-b">
                                <div class="card-body">
                                    ...
                                    <div class="text-inverse-white font-weight-bolder font-size-h5 mb-2 mt-5">Cihaz Durumu Yönetimi</div>
                                </div>
                            </a>
                        </div>
                        @endAuthority
