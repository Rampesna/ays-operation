                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column mr-auto">
                                        <a href="{{ route('employee-panel.project.show', ['project' => $project,'tab' => 'overview']) }}" class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1">
                                            {{ $project->name }}
                                        </a>
                                    </div>
                                        ...
                                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title="Proje Detayları" data-placement="left">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                ...
                                                <ul class="navi navi-hover">
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'overview']) }}" class="navi-link">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tasks', 'sub' => 'kanban']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'timesheets']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'milestones']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'files']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'comments']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tickets']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                                    ...
                                                    <li class="navi-item">
                                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'notes']) }}" class="navi-link">
                                                            <span class="navi-icon">
                                    ...
                                    <div class="d-flex flex-column flex-lg-fill float-left mb-7">
                                        ...
                                        <div class="symbol-group symbol-hover">
                                            @foreach($project->employees as $employee)
                                                @if($loop->iteration <= 5)
                                                    <a href="#" target="_blank" class="symbol symbol-30 symbol-circle" data-toggle="tooltip" title="{{ $employee->name }}">
                            ...
                            <div class="card-footer d-flex align-items-center">
                                <div class="d-flex">
                                    <div class="d-flex align-items-center mr-7">
                                        ...
                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tasks']) }}" class="font-weight-bolder text-primary ml-2">{{ $project->tasks->count() }} Görev</a>
                                    </div>
                                    <div class="d-flex align-items-center mr-7">
                                        <span class="svg-icon svg-icon-gray-500">
                                        ...
                                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'comments']) }}" class="font-weight-bolder text-primary ml-2">{{ $project->comments->count() }} Yorum</a>
                                    </div>
                                </div>
                            </div>
                            <!--end::Footer-->
