...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row text-center">
                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tickets']) }}" class="col-xl-3 border-right pb-4 pt-4 text-dark-75">
                        ...
                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tickets', 'sub' => 1]) }}" class="col-xl-3 border-right pb-4 pt-4 text-dark-75">
                        ...
                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tickets', 'sub' => 2]) }}" class="col-xl-3 border-right pb-4 pt-4 text-dark-75">
                        ...
                        <a href="{{ route('employee-panel.project.show', ['project' => $project, 'tab' => 'tickets', 'sub' => 3]) }}" class="col-xl-3 pb-4 pt-4 text-dark-75">
                ...
                <div class="card-body">
                    <table class="table" id="tickets">
                        ...
                        @foreach($tickets as $ticket)
                            <tr>
                                <td>
                                    <a href="{{ route('employee-panel.project.tickets.ticket', ['project' => $project, 'ticket' => $ticket]) }}">
                                        #{{ $ticket->id }}
                                    </a>
                                </td>
                                <td>
    ...
    @include('employee.pages.project.show.modals.create-ticket')
