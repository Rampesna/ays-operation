...
@section('content')
                            ...
                            <table class="table" id="comments">
                                ...
                                @foreach($project->comments as $comment)
                                    <tr id="row_id_{{ $comment->id }}">
                                        <td>
                                            @if($comment->creator_type == 'App\Models\Employee' && $comment->creator_id == auth()->user()->getId())
    ...
    @include('employee.pages.project.show.modals.create-comment')
    @include('employee.pages.project.show.modals.edit-comment')
