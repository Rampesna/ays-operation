...
@section('content')
    ...
    <div class="row mt-15">
        <div class="col-xl-12">
            <form action="{{ route('employee-panel.project.file.create') }}" class="dropzone dropzone-default" method="post" id="file_upload">
                @csrf
                <input type="hidden" name="uploader_type" value="App\Models\Employee">
